                ...
                <div class="col-md-4">
                    <div class="certificate-card">
                        <div class="image-container">
                            <img src="{{ asset($galleryImage->gallery_image) }}" alt="Certificate {{ $index + 1 }}" class="zoomable-image">
                        </div>
                        <br><br>
                        <button class="btn btn-primary open-modal" data-image="{{ asset($galleryImage->gallery_image) }}">View Fullscreen</button>
                    </div>
                </div>
